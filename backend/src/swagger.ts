    ...
    schemas: {
      ...
      PostResponse: {
        ...
        properties: {
          ...
          wowCount: { type: 'integer' },
          hahaCount: { type: 'integer' }
        }
      },
  ...
  paths: {
    ...
    '/reactions/{postId}': {
      delete: {
        ...
        parameters: [{ name: 'postId', in: 'path', required: true, schema: { type: 'integer' } }],
        responses: { '200': { description: 'Reaction removed', content: { 'application/json': { schema: { $ref: '#/components/schemas/MessageResponse' } } } } }
      }
    }
  }
};
